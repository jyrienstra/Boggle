...
public class Character {
    ...
    public static String getRandomCharacter(){
        ...
        if(chance > 500){
            ...
            return java.lang.Character.toString(letterRange1.charAt(random.nextInt(letterRange1.length())));
        }else{
            String letterRange2 = "bcdfghjklmnpqrstvwxyz"; //medeklinkers
            Random random = new Random();
            return java.lang.Character.toString(letterRange2.charAt(random.nextInt(letterRange2.length())));
        }
    }
}
